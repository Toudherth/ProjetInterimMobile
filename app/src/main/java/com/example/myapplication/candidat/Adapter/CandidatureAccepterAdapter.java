...
public class CandidatureAccepterAdapter extends BaseAdapter {
    ...
    public CandidatureAccepterAdapter(Context context, List<Offre> offreItems){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_candidature_accept, parent, false);
        }
