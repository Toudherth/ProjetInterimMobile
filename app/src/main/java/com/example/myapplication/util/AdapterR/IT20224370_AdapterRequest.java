package com.example.myapplication.util.AdapterR;
...
public class IT20224370_AdapterRequest extends FirebaseRecyclerAdapter<IT20224370_RequestModel, IT20224370_AdapterRequest.myViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull IT20224370_RequestModel model) {
                        ...
                        public void onClick(View v) {
                            ...
                            try {
                                if (TextUtils.isEmpty(name.getText().toString()))
                                    ...
                                    FirebaseDatabase.getInstance("https://interimo2-default-rtdb.firebaseio.com/").getReference().child("requests")
